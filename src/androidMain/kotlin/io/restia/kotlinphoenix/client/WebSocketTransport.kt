        ...
        val listener =
            object : WebSocketListener() {
                ...
                override fun onFailure(
                    ...
                    // TODO: this crashes with no connection
//                    sharedFlow.tryEmit(SocketEvent.FailureEvent(t, response))
                    ...
                    // TODO: this crashes with no connection
//                    sharedFlow.tryEmit(SocketEvent.CloseEvent(WS_CLOSE_ABNORMAL))
                }
                ...
                override fun onMessage(
                    ...
                    sharedFlow.tryEmit(SocketEvent.MessageEvent(decode(text)))
                }
                ...
                override fun onClosed(
                    ...
                    readyState = Transport.ReadyState.CLOSED
                    sharedFlow.tryEmit(SocketEvent.CloseEvent(code))
                }
            }
